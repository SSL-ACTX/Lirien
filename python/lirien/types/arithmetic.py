...
class TypeExpr:
    ...
    def evaluate(self, mapping):
        ...
        for arg in self.args:
            ...
            elif hasattr(arg, "__lirien_typevar__"):
                # It's a LirienTypeVar
                name = arg.__name__
        ...
        if (
            ...
            or hasattr(a, "__lirien_typevar__")
            or hasattr(b, "__lirien_typevar__")
        ):
...
class LirienTypeVar:
    ...
    def __repr__(self):
        return f"LirienTypeVar({self.__name__})"

    def __eq__(self, other):
        if hasattr(other, "__lirien_typevar__"):
...
if typing.TYPE_CHECKING:
    ...
    def TypeVar(name, *args, **kwargs):
        return LirienTypeVar(name, *args, **kwargs)
